function do_lsf_celltrackingND032330241806()
...
analysisparameter.outersize = 60;
analysisparameter.similarityThres = 0.83;
maxWholeImShift = 200;
...
SourceF = '/hms/scratch1/ss240/03-23-2014-10A1806';
%------------------------------------------------
