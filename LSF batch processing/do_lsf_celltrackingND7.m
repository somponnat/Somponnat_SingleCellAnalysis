function do_lsf_celltrackingND7()
...
sourcefolder = '/hms/scratch1/ss240/01-19-2014';
%------------------------------------------------
prefix = ndfilename(1:(end-3));
[notp,stagePos,stageName,channelnames] = readndfile(sourcefolder,ndfilename);
sites        = [4   10 12  19 23 24 26 27 29  30 35 36 40 42 43 45];
endingFrame  = [113 2  192 64 91 10 70 44 159 60 64 45 54 93 67 18];
