...
%
% Last Modified by GUIDE v2.5 01-Feb-2013 16:03:17
...
fftw('planner', 'hybrid');
if filetype~=0
    initialframe = loadimage(filetype,fileformat,[row col field plane channel],tp,channelnames);
...
tp = str2num(get(handles.edit_currentFrame,'String'));
currentframe = loadimage(handles.filetype,get(handles.edit_fileformat,'String'),[row col field plane channel],tp,handles.channelnames);
...
set(handles.slider_frames,'SliderStep',[1/(maxF-minF) 1/(maxF-minF)]);
initialframe = loadimage(handles.filetype,get(handles.edit_fileformat,'String'),[row col field plane channel],tp,handles.channelnames);
...
currentframe = loadimage(handles.filetype,get(handles.edit_fileformat,'String'),[row col field plane channel],c_tp,handles.channelnames);
...
firstframe = loadimage(handles.filetype,fileformat,[row col field plane channel],tp,handles.channelnames);
set(handles.edit_currentFrame,'String',num2str(tp));    
...
previousframe = loadimage(handles.filetype,fileformat,[row col field plane channel],pre_tp,handles.channelnames);
if handles.filetype == 3
    filename = sprintf(fileformat,handles.channelnames{channel},first_tp);
    first_info = imfinfo(filename);
...
nextframe = loadimage(handles.filetype,fileformat,[row col field plane channel],post_tp,handles.channelnames);
if handles.filetype == 3
...
first_tp = str2num(get(handles.edit_firstframe,'String'));
fileformat = get(handles.edit_fileformat,'String');
lastframe = loadimage(handles.filetype,get(handles.edit_fileformat,'String'),[row col field plane channel],tp,handles.channelnames);
...
if c_tp~=endFrame+handles.increment
    ...
    for tp=c_tp:handles.increment:endFrame
        set(handles.slider_frames,'Value',tp);
        currentframe = loadimage(handles.filetype,fileformat,[row col field plane channel],tp,handles.channelnames);
        if handles.filetype == 3
            filename = sprintf(fileformat,handles.channelnames{channel},tp);
            current_info = imfinfo(filename);
            [Y, M, D, H, MN, S]  = datevec(datenum(current_info.DateTime,'yyyymmdd HH:MM:SS.FFF')-datenum(first_info.DateTime,'yyyymmdd HH:MM:SS.FFF'));
...
previousframe = loadimage(handles.filetype,get(handles.edit_fileformat,'String'),[row col field plane channel],currentFrame,handles.channelnames);
currentframe = loadimage(handles.filetype,get(handles.edit_fileformat,'String'),[row col field plane channel],nextframe,handles.channelnames);
...
if cFrame~=endFrame+handles.increment
    ...
    for t=cFrame:handles.increment:endFrame
        ...
        tp=t;
        previousframe = loadimage(handles.filetype,get(handles.edit_fileformat,'String'),[row col field plane channel],tp,handles.channelnames);
...
if cFrame~=endFrame
    tp=cFrame+handles.increment;
    nextframe = loadimage(handles.filetype,get(handles.edit_fileformat,'String'),[row col field plane channel],tp,handles.channelnames);
...
handles.p = p;
handles.bg_p = bg_p;
set(handles.edit_commu,'String',['Loaded data from ' savefile]);
guidata(hObject, handles);
handles = guidata(hObject);
...
set(handles.edit_commu,'String',['Your data is saved to ' savefile]);
...
if currentFrame~=endframe+handles.increment
    ...
    currentframe = loadimage(handles.filetype,get(handles.edit_fileformat,'String'),[row col field plane channel],currentFrame+handles.increment,handles.channelnames);
