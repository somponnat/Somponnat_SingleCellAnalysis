function do_lsf_celltrackingND8()
...
minAreaRatio=1.25;
minCytosolWidth=5;
save celltrackingparameters3;
%---------------------------------------
ndfilename ='04042014-r1.nd';
sourcefolder = '/hms/scratch1/ss240/04-04-2014';
%------------------------------------------------
prefix = ndfilename(1:(end-3));
[notp,stagePos,stageName,channelnames] = readndfile(sourcefolder,ndfilename);

sites        = [1  4  11   12 25 30  37  48   60   77 78  79];
endingFrame  = [36 39 notp 68 8  142 111 notp notp 19 108 10];
...
for i = 1:length(sites)
    ...
    plane = 1;
    tps = [1 endingFrame(i)];
    job.createTask(@CellTracking_commandline2, 0, ...
