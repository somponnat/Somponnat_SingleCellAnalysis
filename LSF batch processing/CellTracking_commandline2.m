function CellTracking_commandline2(filetype,SourceF,row,col,field,plane,channel,tps,increment,fileformat,channelnames,cellsize,outersize,similarityThres)
