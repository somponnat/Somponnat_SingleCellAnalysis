function do_lsf_collectDataND02272014EKAREV()
...
analysisparam.CH1 = 1;
analysisparam.CH2 = 2;
analysisparam.nominCH = 4;
analysisparam.denominCH = 3;
...
analysisparam.illumlogic = 1; % 1 = use high-pass filtering, 0 = no filtering
...
analysisparam.signaltype = [1 1 3 3];%1=ch1,2=ch2,3=nominCH/denominCH
...
analysisparam.output_name = 'mCherry/EKAREV';
...
ndpathname = '/hms/scratch1/ss240/02-27-2014';
%------------------------------------------------
prefix = ndfilename(1:(end-3));
[notp,stagePos,stageName,channelnames] = readndfile(ndpathname,ndfilename);

tps = [1 notp];
sites = [1	2	3 18	17	16 19	20	21 36	35	34 37	38	39 54	53	52 55	56	57];
...
for site = sites
    ...
    job.createTask(@CollectData_commandline, 0, {analysisparam});
    save(['site' num2str(site) 'analysis.mat'],'analysisparam');
end
